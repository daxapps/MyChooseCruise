...
class INIntentHandler: INExtension, INRidesharingDomainHandling {
    ...
    func handle(requestRide intent: INRequestRideIntent, completion: @escaping (INRequestRideIntentResponse) -> Void) {
        ...
        //give it the pickup and drop off location we already agreed with the user
        ...
        //set the vehicles current location to wherever the user wants to go, this ought to at least place it a little way away for testing purposes
